        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="<?=base_url()?>admin/login/login_ol" method="post">
              ...
              <div>
                <button class="btn btn-default submit" >Giriş Yap</button>
              ...
              <div class="separator">
                <p class="change_link">Sitemizde Yeni misiniz?
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Mobil Eleştiri</h1>
                  <p>©2016 All Rights Reserved. Mobil Eleştiri! is a Bootstrap 3 template. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
