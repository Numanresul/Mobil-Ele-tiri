                  ...
                  <div class="x_content">
                    <br />
                     <table class="table">
                      ...
                      <tbody>
                        <tr> 
						  <td scope="row"><?=$veri[0]->id?></td>
                          <td scope="row"><?=$veri[0]->adsoy?></td>
                          <td scope="row"><?=$veri[0]->email?></td>
                          <td scope="row"><?=$veri[0]->yetki?></td>
                         
						  <td scope="row"><?=$veri[0]->durum?></td>
						  <td scope="row"><?=$veri[0]->sifre?></td>
						   <td scope="row"><?=$veri[0]->cinsiyet?></td>
                        </tr>
