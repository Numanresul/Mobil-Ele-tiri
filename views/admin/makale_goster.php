                  ...
                  <div class="x_content">
                    <br />
                     <table class="table">
					   ...
					   <tr>
					   <th>Makale Id<th/>
					    <td><?=$makaleler[0]->id?></td>
					   </tr>
					   <tr>
					   <th>Makale Konu<th/>
					    <td><?=$makaleler[0]->konu?></td>
					   </tr>
					   <tr>
					   <th>Makale Başlık<th/>
					    <td><?=$makaleler[0]->baslik?></td>
					   </tr>
					   <tr>
					   <th>Makale Açıklama<th/>
					    <td><?=$makaleler[0]->aciklama?></td>
					   </tr>
					   <tr>
					   <th>Makale Keywords<th/>
					    <td><?=$makaleler[0]->keywords?></td>
					   </tr>
