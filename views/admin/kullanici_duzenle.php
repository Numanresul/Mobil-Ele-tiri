		  ...
		  <div class="clearfix"></div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Kullanıcı Düzenleme Formu <small>değişiklik yapmak istediğiniz alanları doldurunuz!</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?=base_url()?>admin/KullanicilarYON/guncellekaydet/<?=$veri[0]->id?>" method="post">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Ad, Soyad <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="adsoy" value="<?=$veri[0]->adsoy?>" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="email" value="<?=$veri[0]->email?>" id="last-name" name="last-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name="yetki"  class="form-control">
							...
							<option>Yetki Durumunu Seçiniz</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
						 ...
						 <option><?=$veri[0]->durum?></option>
                            <option>Kullanıcı Durumunu Seçiniz</option>
                            <option>Aktif</option>
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="sifre" value="<?=$veri[0]->sifre?>" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
